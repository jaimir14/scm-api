-- Drop indexes if they were partially created by a previous failed run
DROP INDEX `patients_clinica_id_created_at_idx` ON `patients`;
DROP INDEX `patients_clinica_id_nombre_apellido1_apellido2_idx` ON `patients`;
DROP INDEX `patients_clinica_id_numero_identificacion_idx` ON `patients`;
